        ...
        <div className="w-full max-w-[420px]">
          ...
          <div className="mb-6">
            ...
            <input
              ...
              placeholder="gsk_..."
              className="block h-12 w-full border border-[var(--border)] bg-white px-4 font-mono text-[14px] text-[var(--foreground)] placeholder:text-[var(--label)] focus:border-[var(--foreground)] focus:outline-none"
            />
          </div>
